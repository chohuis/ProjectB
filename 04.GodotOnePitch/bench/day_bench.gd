...
##
## ⚠ **2026-08-18에 1.0 → 3.0으로 늘렸다 (사용자 확정).** 늘린 이유가 있다 —
...
##   · `NpcGrowth`의 좁은 창
##
## ⚠ **여유를 다 쓰라는 뜻이 아니다.** 3.0은 한계고, 넘는 순간 멈추고 보고한다
const GATE_DAY_SECONDS: float = 3.0
...
const GATE_DAY_WALL_SECONDS: float = 6.0
