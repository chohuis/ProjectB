...
| ⬜ **U-8** | 관계 7색이 이웃끼리 안 갈린다 (신뢰↔각별 대비 **1.06**) | `theme.gd:45-53` | 없다 |
...
**U-8만 남았다** (2026-08-16 기준). 나머지 아홉은 끝났다.

⚠ 한때 "U-1~U-10을 다 했다"고 적었는데 **틀렸다.** U-8(관계 7색)은 보고서에서
대비를 재기만 했고 `theme.gd`는 안 고쳤다 — 표를 다시 세어 잡았다.
