...
마지막 갱신: 2026-08-13 · 커밋 `1554b49c9`
...
이주 중. P0·P1·**M1·M2·M3-1·D1·D2** 끝났고 **M4(성장) 진행 중**.
...
`growth.gd`에 순수 산식(XP·잠재력·나이·주간 XP·레벨업·피로 승수)이 끝났다.
남은 것: `calc_training_growth` · `calc_game_growth` · `plan_load` ·
`calc_protagonist_aging` · NPC 성장.
