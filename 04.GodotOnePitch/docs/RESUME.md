...
마지막 갱신: 2026-08-14 · 커밋 085ebf2c7
...
이주 중. **M1~M6·M8·D1~D3 끝났다.** M7(화면)이 진행 중 — **새 게임이 실제로 돌아간다**(팀 238·선수 7,337·일정 6,396경기). 진행·저장·경기·순위표가 이어졌고 나머지 화면이 남았다.
