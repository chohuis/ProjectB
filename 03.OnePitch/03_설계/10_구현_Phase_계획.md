...
**I0~I6 완료(I6는 10차분까지, §6-29), I7은 12차분까지 완료(팀명 버그·에러UI·로딩·전환애니메이션·테마 전부 §6-34·§6-35), I8은 1차분 착수(밸런스 하네스, §6-36).** 사용자 실플레이 피드백 4가지(①팀명 ②디자인 ③성능 ④콘텐츠 공백) 중 ①②는 완료, ③은 `--release`로 "조금 나아짐" 확인 후 보류(추가 프로파일링은 필요해지면), ④가 I8로 진행 중.
