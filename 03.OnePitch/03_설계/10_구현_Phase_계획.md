...
| 나머지 이벤트 13개(38개 중 25개 저작 완료 — §6-120·§6-121, 2026-07-25, 문장 뱅크 엔진+고교 1·2차 배치 14개)·서사형 업적·뉴스·미디어 | 저작 시간 문제 — 파이프라인·문장 뱅크는 갖춰짐. 남은 13개 중 대부분(FA·트레이드·콜업강등·스토브리그 등)은 프로/대학 전용이라 고교엔 해당 없음, 데뷔전·대회우승 확정은 콜백 훅 신설 필요 | 반복 저작 세션 — 대학/프로 소재로 이어가거나, 데뷔전·대회우승용 콜백 훅부터 엔진에 배선 | 콘텐츠 저작(반복) |
