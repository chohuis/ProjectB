...
/// 사이드 내비(`AppSidebar`, 대화 2026-07-22부터 리스트형 레이아웃으로
/// 교체 — 이전엔 Material `NavigationRail`), 모바일은 바텀 내비(`NavigationBar`).
...
void main() {
  ...
  testWidgets('shows an AppSidebar on wide screens and switches destinations', (tester) async {
    ...
    expect(tester.widget<AppSidebar>(find.byType(AppSidebar)).selectedIndex, 0);
