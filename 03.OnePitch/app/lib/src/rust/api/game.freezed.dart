...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MatchStepInfo);
}
...
/// @nodoc
class $MatchStepInfoCopyWith<$Res>  {
$MatchStepInfoCopyWith(MatchStepInfo _, $Res Function(MatchStepInfo) __);
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String batterId,  int balls,  int strikes,  bool highLeverage)?  awaitingPitch,TResult Function( int homeRuns,  int awayRuns)?  gameOver,required TResult orElse(),}) {final _that = this;
switch (_that) {
case MatchStepInfo_AwaitingPitch() when awaitingPitch != null:
return awaitingPitch(_that.batterId,_that.balls,_that.strikes,_that.highLeverage);case MatchStepInfo_GameOver() when gameOver != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String batterId,  int balls,  int strikes,  bool highLeverage)  awaitingPitch,required TResult Function( int homeRuns,  int awayRuns)  gameOver,}) {final _that = this;
switch (_that) {
case MatchStepInfo_AwaitingPitch():
return awaitingPitch(_that.batterId,_that.balls,_that.strikes,_that.highLeverage);case MatchStepInfo_GameOver():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String batterId,  int balls,  int strikes,  bool highLeverage)?  awaitingPitch,TResult? Function( int homeRuns,  int awayRuns)?  gameOver,}) {final _that = this;
switch (_that) {
case MatchStepInfo_AwaitingPitch() when awaitingPitch != null:
return awaitingPitch(_that.batterId,_that.balls,_that.strikes,_that.highLeverage);case MatchStepInfo_GameOver() when gameOver != null:
return gameOver(_that.homeRuns,_that.awayRuns);case _:
...
class MatchStepInfo_AwaitingPitch extends MatchStepInfo {
  const MatchStepInfo_AwaitingPitch({required this.batterId, required this.balls, required this.strikes, required this.highLeverage}): super._();
...
@useResult
$Res call({
 String batterId, int balls, int strikes, bool highLeverage
});
...
/// Create a copy of MatchStepInfo
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? batterId = null,Object? balls = null,Object? strikes = null,Object? highLeverage = null,}) {
...
/// Create a copy of MatchStepInfo
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? homeRuns = null,Object? awayRuns = null,}) {
