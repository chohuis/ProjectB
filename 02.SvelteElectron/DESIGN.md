...
| 영역 | v2 변경 |
|---|---|
| **세계 규모** | Lite 반경 시뮬(활성 ~250명) → **8권역 172팀 전부 풀 시뮬**. 시즌당 국내 ~2,635경기 |
...
**시즌당 국내 경기 수 ≈ 2,635** (고교 1,020 + 대학 225 + 독립 175 + 1군 720 + 2군 495).
...
- [ ] 독립 4단계 생존리그 · 프로 5강 사다리 · 2군 축약 PO
...
**R6d — 성능** — 국내 2,635경기(v1 대비 3.4배)가 설계 제약이다.
