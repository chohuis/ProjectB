...
- [x] **7-4** 방출 2단계 · FA 등급제 · 구단주 관계 — 설계 [docs/design/fa.md](docs/design/fa.md)
      ...
      - [ ] 주인공 재계약 UI 경로 · NPC FA 시장 오프시즌 배선 → 7-5/7-6 이월
- [ ] **7-5** 개인 재정 전체 · 스태프 15종 배선 · 부상 전조 경고
- [ ] **7-6** 문장 뱅크 엔진 · 뉴스 4종 · **팀동료 이벤트 분기**(6C 이월) ·
      감정 시스템에서 걷어낸 문구 12건 재작성
- [ ] **7-7** 대학 쇼케이스 · 올스타전 (Phase 6 이월)
