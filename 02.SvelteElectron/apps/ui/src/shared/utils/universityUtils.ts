...
> = {
  ...
  //   전부 떨어질 확률이 2.7% 였다 — **사실상 전원 합격**이다
  //   (`BALANCE_PROPOSAL_102.md` §① · `week_engine.rs calc_hs_admissions`).
...
export function primeCareerScoreRules(rulesFile: {
  careerScoreRules?: {
    highschool?: Partial<HsScoreTable>;
    individual?: Partial<IndividualScoreTable>;
  };
}): void {
