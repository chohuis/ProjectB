...
**세션·도구**
- 🔴 **서브에이전트는 배경 실행·Monitor 를 쓰지 않는다 — 긴 작업은 전경에서 타임아웃을 넉넉히(600000ms) 주고 기다린다.** 턴이 끝나면 아무도 깨우지 않는다 · 「완료되면 알려 준다」「Monitor 가 깨운다」는 문장은 틀렸다. 이걸로 판이 두 번 죽고 D 가 네 번 멈췄다(09-11~12). 완벽한 표본보다 **끝난 보고**가 먼저다 — 못 잰 것은 「못 쟀다」로 적는다
