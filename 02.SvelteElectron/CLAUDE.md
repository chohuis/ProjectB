...
>
> ```
> resource/data/master/events/   553건 (필수 · 조건부 · 랜덤)
...
> **19건짜리 스텅으로 조용히 폴백**하고 `console.warn` 한 줄만 남겼다. 콘텐츠의
> **3.5%**로 게임이 그냥 돌았고, B가 그 상태로 6시즌을 재고 오진했다.
> B가 `throw`로 바꿨다 — 이젠 매니페스트가 없으면 안 뜼다.
>
...
> 그 부류였고(조건 오타로 35종 사망 · 업적 해금 불가 · 스텅 폴백),
