...
| 18 | 회신 결함 수정 (빌드 눈확인 뒤) | **사용자 → C** | 🔄 **사용자가 직접 포장본을 만져 본다**(09-04 확정 · C 눈확인 세션을 아낀다) → 나온 결함을 C 가 고치면 20/20. 확인 목록 `USER_TEST_CHECKLIST_2026-09-04.md` |
