...
**완료 14 / 19 ≈ 74%** (09-03 18:4x). 1.0.0 고정 = 19 전부 ✅ · 그 뒤 BALANCE_BACKLOG 조정 → 1.0.1.
...
├─ 29. ✅ **B-29 NPC 생성 이력 검토**(cfb02acdf · NPC_HISTORY_REVIEW · 뿌리: 이력이 셋(과거 성적·입단/이적·진행 사건)으로 나뉘어 서로 안 봄 · 높음 3: 승격/강등/방출이 경력에 안 남음 · 과거 성적 팀이 이적 무시 · FA 자격 연차 정본 둘(8 vs 5/6/4) · 중간 4 · 낮음 3 · 25세 연차 0/32세 연차 2 는 결함 아님 · ❓ 사용자 결정 다섯 · D 덤프 넷)
