...
=======
| 15 | 소식함 FIFO 한 줄 + 군 조건 위생 검사 정정 (C/A) | C | 🔄 FIFO ✅ 2d8d7d601(「안 읽음 우선」 삭제 · 미결 보존은 그대로) · 위생 검사 정정(A 몫) 남음 |
>>>>>>> track/ui
...
=======
**완료 11 / 19 ≈ 58%** (09-03 18:4x). 1.0.0 고정 = 19 전부 ✅ · 그 뒤 BALANCE_BACKLOG 조정 → 1.0.1.
>>>>>>> track/ui
