...
| 17 | 병영 재회 이벤트 — 축소판(위생 검사 값 기준 · 조건 키 셋 · 관계 종류 unitmate · 이름 렌더러 없음) | A → B | ⬜ 확정(축소 · 09-03) |
| 17-b | 대학 학습 강도 선택지 이벤트 · Y4 W50 890 삭제 · 고교 부진 이벤트 3~5종 (B-24) | B | ✅ cd603c416 (학습 강도는 studyQualityDelta 로 · `studyModeSet` 효과 키는 A 몫 · 890 은 "안 뜸"이 아니라 필수라 두 통 왔던 것) |
