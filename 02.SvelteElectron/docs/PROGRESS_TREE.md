...
├─ 13. 🔄 **(당김 · 9/9 몫)** 전 경로 헤드리스 한 바퀴 — ✅ pro(씨앗 02 · 12시즌 · 고교 미지명→군→독립→**독립 재지명**→KBL 서울 · 포스트시즌 2) · ✅ univ(씨앗 02 · 12시즌 · 대학 4년→해외 2군 제안 2→pro_abl) · ⬜ indie·mil 은 밸런스 판 뒤
├─ 14. 🔄 **(당김 · 9/4 몫)** 병영 밸런스 1차 표 — 9/9 돌렸는데 **씨앗과 무관하게 전부 같았다** → 🔴 결함 발견: initSeason 이 worldSeed 를 버림(입대 뒤 굴림 전부 0) → 고침(e0298ec53) · 아홉 판 **재실행 필요**(pack 뒤)
