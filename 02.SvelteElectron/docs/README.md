...
| **`SIM_REPORT_2026-09-21_final24d.md`** | 🔴 **1.0.2 계측 마감 정본 — 24판 네 번째.** 워커 연도 라벨 고침(`cef688b5a`) 뒤 재계측 · 네 판 나란히 · `report-simruns.cjs` 자체의 무대-접힘 잣대 결함을 찾아 고침(고졸직행 87.5%→33.3%) · 고졸직행 처음 범위 안 · 군 24/24 완주 · 폴백 -21%(B 고교 레어 수정) | 정본 |
