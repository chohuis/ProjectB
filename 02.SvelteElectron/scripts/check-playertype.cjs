...
//   이 369 가 그 크기다.
const CAP_WORD = 75;
//   ⚠ 369 → 374 (2026-09-08 · 4-2 ③). 얇은 무대 읽기만 12종에 갈래를 붙이면서
//   그중 다섯이 투구 XP 를 준다(제구 2 · 구속 1 · 멘탈 1 · 위기집중력 1).
//   갈래를 안 붙이면 그 무대의 노말이 안 차고, 붙이면 이 숫자가 는다 —
//   **타자가 열리는 날 같이 갈라야 할 자리로 센다.**
const CAP_REWARD = 374;
let bad = false;
