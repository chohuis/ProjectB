...
// 🔴 **추론은 2026-09-08 에 없어졌다.** 예전엔 「안 적으면 oncePolicy 로
//   추론한다」고 적혀 있었는데, 그 문장이 남아 있으면 등급을 안 적어도 되는
//   줄 안다 — 지금은 안 적은 규칙이 **등급 줄기를 아예 안 탄다.**
log("  등급명시 = `tier`를 적은 규칙 수 (안 적으면 등급 줄기를 안 탄다 — 필수 101종이 그렇다)");
log("");
